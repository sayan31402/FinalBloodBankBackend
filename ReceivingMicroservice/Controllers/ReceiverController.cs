...
using ReceiverMicroservice.Models.DTO;
using ReceiverMicroservice.Repository;
    ...
    public class ReceiverController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddReceiver([FromBody] ReceiverDTO receiverDTO)
        {
            try
            {
                ...
                else
                {
                    ...
                    return StatusCode(500, new { message = "Receiver Add Failure" });
                }
            }

            //----Catch ****
            catch (Exception ex) { return StatusCode(500, new { message = $"Receiver Add Failure due to {ex.Message}" }); }
        ...
        public async Task<IActionResult> UpdateReceiver(int Id, [FromBody] ReceiverDTO receiverDTO)
        {
            try 
            {
                ...
                return StatusCode(500, new { message = "Receiver Update Failure: Receiver Id doesnot exist" });
            }
        ...
        public async Task<IActionResult> DeleteReceiver(int Id)
        {
            ...
            return StatusCode(500, new { message = "Receiver Delete Failure" });
