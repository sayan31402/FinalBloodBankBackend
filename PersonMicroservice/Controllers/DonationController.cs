    ...
    public class DonationController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddDonor([FromBody] DonorDTO donorDTO)
        {
            try
            {
                ...
                else
                {
                    ...
                    return StatusCode(400, new { message = "Donor Add Failure" });
                }
            }

            //----Catch ****
            catch (Exception ex) { return StatusCode(400, new { message = $"Donor Add Failure due to {ex.Message}" }); }
        ...
        public async Task<IActionResult> UpdateDonor(int Id, [FromBody] DonorDTO donorDTO)
        {
            try 
            {
                ...
                if (res) 
                {
                    //await UpdateStock(donorDTO.PersonBloodGroup, (donorDTO.Quantity - existingDonor.Quantity));
                ...
                return StatusCode(400, new { message = "Donor Update Failure: Donor Id doesnot exist" });
            }
        ...
        public async Task<IActionResult> DeleteDonor(int Id)
        {
            ...
            return StatusCode(400, new { message = "Donor Delete Failure" });
